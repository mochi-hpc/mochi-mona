...
static MunitResult test_send_recv_self(const MunitParameter params[],
                                       void*                data)
{
    (void)params;
    ...
    ret = mona_irecv(mona, buf1, msg_len, context->self_addr, 1234, NULL, NULL,
                     NULL, &req);
    munit_assert_int(ret, ==, NA_SUCCESS);
...
static MunitTest test_suite_tests[]
    = {{(char*)"/hl", test_send_recv_self, test_context_setup,
        test_context_tear_down, MUNIT_TEST_OPTION_NONE, NULL},
       {NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL}};

static const MunitSuite test_suite
    = {(char*)"/mona/send-recv-self", test_suite_tests, NULL, 1,
