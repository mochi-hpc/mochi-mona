...
static MunitResult test_allgather(const MunitParameter params[], void* data)
{
    (void)params;
    ...
    ret = mona_comm_allgather(context->comm, send_buf, 8096, recv_buf, 1234);
    munit_assert_int(ret, ==, NA_SUCCESS);
...
static MunitTest test_suite_tests[] = {
    { (char*) "/allgather", test_allgather, test_context_setup, test_context_tear_down, MUNIT_TEST_OPTION_NONE, NULL },
