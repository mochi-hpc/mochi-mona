...
static MunitResult test_gatherv(const MunitParameter params[], void* data)
{
    ...
    // gatherv to rank 0
    ret = mona_comm_gatherv(context->comm, send_buf, 8096 + rank * 64, recv_buf,
                            recv_sizes, offsets, 0, 1234);
    munit_assert_int(ret, ==, NA_SUCCESS);
...
static MunitTest test_suite_tests[]
    = {{(char*)"/gatherv", test_gatherv, test_context_setup,
